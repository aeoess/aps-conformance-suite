...
**APS's canonical vectors (`V1`–`V4` in this directory) are the source of truth.**
...
|---|---|---|---|---|---|---|
| `V1-narrowing-valid` | — | ACCEPT | `aae-vector-91` ACCEPT @9 | `06-delegation-valid-depth-2` | ACCEPT @ step 9 | §3, §5 step 9 |
...
1. **Format — signed JWS vs unsigned envelope.** MoltyCel's vectors are EdDSA-signed
   ...
   (§5 step 1). APS's canonical `V1`–`V4` are unsigned AAE-shape JSON
