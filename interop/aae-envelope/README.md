...
|---|---|---|---|---|---|
| **V1-narrowing-valid** | ACCEPT | child `[read]` ⊆ parent `[read, write]`, both windows current, not revoked | §2.2/2.3 scope | — | `tests/property-delegation.test.ts` (INV-2 Scope Monotonic Narrowing); `scopeCovers` |
